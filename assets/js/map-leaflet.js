$(document).ready(function($) {
        ...
        $.ajax({
            ...
            success: function (results) {
                ...
                if (typeof parameters !== "undefined" && parameters["formData"]) {
                    ...
                    window.jsonfile = loadedMarkersData;
                }
    ...
    document.getElementsByClassName('custom-control-input')[0].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[1].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[2].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[3].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[4].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[5].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[6].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[7].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[8].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[9].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[10].onclick = filterFunction;
    document.getElementsByClassName('custom-control-input')[11].onclick = filterFunction;
        ...
        for (var i = 0; i < loadedMarkersData.length; i++) {
            ...
            markerContent.innerHTML =
                '<div class="ts-marker-wrapper">' +
                    ...
                    ( ( loadedMarkersData[i]["layers"] !== undefined ) ? '<div class="ts-marker__layer">' + loadedMarkersData[i]["layers"] + '</div>' : "" ) +
